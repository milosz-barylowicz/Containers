...
TEST_F(VectorTestSuite,
       ShouldChangeSizeCapacityAndFillVectorWithPassedValueWhenResizing) {
...
TEST_F(VectorTestSuite,
       ShouldAccessFirstElementAndCouldModifyItWhenCallingBack) {
  auto last = sut.back();
...
TEST_F(VectorTestSuite,
       ShouldAccessFirstElementAndCouldModifyItWhenCallingFront) {
